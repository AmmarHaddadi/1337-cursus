...
/*   Updated: 2024/10/28 11:06:41 by ahaddadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	run_test("Test 1: Normal string and valid file descriptor", "Hello, World!", "test1.txt");

// 	// Test case 2: NULL string and valid file descriptor
// 	run_test("Test 2: NULL string and valid file descriptor", NULL, "test2.txt");
...
// 	run_test("Test 4: Normal string and invalid file descriptor", "This should not be written", "test4.txt");

// 	// Test case 5: NULL string and invalid file descriptor
// 	run_test("Test 5: NULL string and invalid file descriptor", NULL, "test5.txt");

// 	// Test case 6: Empty string and invalid file descriptor
// 	run_test("Test 6: Empty string and invalid file descriptor", "", "test6.txt");
